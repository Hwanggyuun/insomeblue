        ...
        <div className={styles.Box}>
            <div className={styles.itembox}>
                ...
                <div className={styles.item}>
                    ...
                    <div className={styles.content}>행사 기획과 컨셉에 맞는 기획과 아티스트, 뮤지션,아나운서 등 엔터테이너 섭외는 물론 현장 운영까지 가능합니다.</div>
                </div>
            </div>
            <div className={styles.itembox}>
                <div className={styles.item}>
                    <div className={styles.number}>02</div>
                    <div className={styles.title}>무대 시스템</div>
                    <div className={styles.content}>야외부터 실내까지, 장소, 공간과 규모, 취지와 컨셉에 맞춤으로 무대를 제작합니다.</div>
                </div>
            ...
            <div className={styles.itembox}>
                ...
                <div className={styles.item}>
                    ...
                    <div className={styles.content}>키비쥬얼시안 제작 후 포스터, 현수막, 발표집, 명찰, 명패, PPT, 기념품 등 행사에 필요한 모든 디자인을 제작합니다.</div>
                </div>
            </div>
            <div className={styles.itembox}>
                <div className={styles.item}>
                    ...
                    <div className={styles.content}>간단한 다과 세팅부터 핑거푸드와 음료, 도시락 등 행사에 최적화된 케이터링을 세팅합니다.</div>
                </div>
